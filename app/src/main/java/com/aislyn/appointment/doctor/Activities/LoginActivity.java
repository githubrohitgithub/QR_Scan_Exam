...
public class LoginActivity extends AppCompatActivity  {
   ...
   ImageView plusbutton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dractivity_login);
    ...
    private void userLogin() {
       ...
       Call<DLoginResponse> call= DoctorRetrofitClient.getInstance()
               .getApi()
               .login(userEmail,userpass);

        call.enqueue(new Callback<DLoginResponse>() {
            @Override
            public void onResponse(Call<DLoginResponse> call, Response<DLoginResponse> response) {

                DLoginResponse loginResponse=response.body();
                ...
                if(response.isSuccessful()){
                    ...
                    if(loginResponse.getError().equals("200")){
                        ...
                        Toast.makeText(LoginActivity.this, "Hello "+response.body().getUser().getDrname(), Toast.LENGTH_SHORT).show();

                        drsharedPrefmanager.saveuser(loginResponse.getUser());

                        Intent intent=new Intent(LoginActivity.this, DRHomeActivity.class);
            ...
            @Override
            public void onFailure(Call<DLoginResponse> call, Throwable t) {
    ...
    protected void onStart() {
        ...
        if(drsharedPrefmanager.isLoggedIn()){
            Intent intent=new Intent(LoginActivity.this, DRHomeActivity.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK|Intent.FLAG_ACTIVITY_CLEAR_TASK);
            startActivity(intent);
        }
