package com.hesa.pdfcreator.utils;
...
public class PDFUtil {
     ...
     */
    private static final double PDF_PAGE_WIDTH = 10.3 * 72;
    /**
     ...
     */
    public static class GeneratePDFAsync extends AsyncTask<Void, Void, File> {
